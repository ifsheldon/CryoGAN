...
class ConditionalGANLoss(object):
...
class StandardGAN(GANLoss):
    ...
    def __init__(self, dis):
        ...
        super(StandardGAN, self).__init__(dis)
...
class WGAN_GP(GANLoss):
    ...
    def __init__(self, dis, drift=0.001, use_gp=False):
        super(WGAN_GP, self).__init__(dis)
        self.drift = drift
        self.use_gp = use_gp

    def __gradient_penalty(self, real_samps, fake_samps,
                           height, alpha, reg_lambda):
        """
    ...
    def dis_loss(self, real_samps, fake_samps, height, alpha, reg_lambda):
        ...
        if self.use_gp:
            ...
            gp = self.__stable_gradient_penalty(real_samps, fake_samps, height, alpha, reg_lambda)
            loss += gp
...
class LSGAN_SIGMOID(GANLoss):
    ...
    def __init__(self, dis):
        super(LSGAN_SIGMOID, self).__init__(dis)
...
class HingeGAN(GANLoss):
    ...
    def __init__(self, dis):
        super(HingeGAN, self).__init__(dis)
...
class RelativisticAverageHingeGAN(GANLoss):
    ...
    def __init__(self, dis):
        super(RelativisticAverageHingeGAN, self).__init__(dis)
...
class CondStandardGAN(ConditionalGANLoss):
    ...
    def __init__(self, dis):
        ...
        super(CondStandardGAN, self).__init__(dis)
...
class CondLSGAN(ConditionalGANLoss):
    ...
    def __init__(self, dis):
        super(CondLSGAN, self).__init__(dis)
...
class CondLSGAN_SIGMOID(ConditionalGANLoss):
    ...
    def __init__(self, dis):
        super(CondLSGAN_SIGMOID, self).__init__(dis)
...
class CondHingeGAN(ConditionalGANLoss):
    ...
    def __init__(self, dis):
        super(CondHingeGAN, self).__init__(dis)
...
class CondRelativisticAverageHingeGAN(ConditionalGANLoss):
    ...
    def __init__(self, dis):
        super(CondRelativisticAverageHingeGAN, self).__init__(dis)
