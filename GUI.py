...
def Central():
    ...
    parser.add_argument('config', default="Configs/train_New_Betagal-Synthetic-NoiseCTF.cfg",
...
dictConfig = []
dictConfig.append(
    ["general", ["name", "AlgoType", "DatasetSize", "snr_ratio", "DownSampleRate", "use2gpu", "device", "NoisePerCTF"]])

dictConfig.append(["data", ["dataset", "dataset_name", "data_type", "UseOtherDis", "ThresholdResolution", "PixelSize",
                            "FreezeResolution"]])
